This is a fully functional example of a solr search component plugin with the necessary schema, solrconfig files and a sample doc all included under /src/main/resources.
